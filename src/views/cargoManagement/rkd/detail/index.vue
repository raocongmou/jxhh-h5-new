    ...
    <van-tabs v-model:active="tabActive" @change="onClickTab">
        ...
        <Scroll class="wrappers-main wrappers" wrapper="mainRef" ref="main">
          <van-form @submit="onSubmit" label-width="100">
            ...
            <van-field
              input-align="left"
              readonly
              v-model="formData.cFlag"
              :formatter="(value) => getStatus(value, 'cFlag')"
              label="入库状态"
            />
            <van-field
              readonly
            ...
            <van-field
              ...
              label="币别"
            />
              <!-- :formatter="(value) => getStatus(value, 'currencyCode')" -->
            <van-field
              input-align="left"
              readonly
      ...
      <van-tab title="入库商品">
        <div class="detail_item">
          ...
          >
            <div v-if="formData.m1Items.length">
                ...
                >
                  ...
                  > -->
                    ...
                    <van-form label-width="100">
                      ...
                      />
                      <van-field
                        v-model="item.amountRMB"
                        readonly
                        label="实入含税金额"
                        input-align="left"
                      />
                      <van-field
                        v-model="item.amountRMBNt"
                        aria-readonly=""
                        label="实入无税金额"
                        input-align="left"
                      />
