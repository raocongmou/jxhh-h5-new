...
import { getCargoManagementList } from "@/api/cargoManagement/rkd";
...
export default {
  ...
  methods: {
    ...
    longClickAction(action) {
      ...
      if (action.name === "预览") {
        let keyValue = action.items.wareHsId;
    ...
    loadData() {
      ...
      getCargoManagementList(this.queryForm).then((res) => {
